...
|---|------------------------------------------------------------------------------------------------------|:------:|----------------|----------------------------------|
| 0 | The team has closed and merged the past Feedback PR(s), indicating that they have read the feedback. | ❌      | Feedback PR #4 (feedback-week4) is still open/unmerged; please review and merge to acknowledge prior feedback. |                                  |

### Software Process Quality
| # | Item                                                                                                                                         | Status | Reviewer Notes | Source Instructions or Resources                                                                              |
|---|----------------------------------------------------------------------------------------------------------------------------------------------|:------:|----------------|---------------------------------------------------------------------------------------------------------------|
| 1 | Checkstyle: Checkstyle is set up or there is a to-do item planned in the Project Management board for this task. (needed for Letter Grade B) | ⚠️     | No `checkstyle` configuration detected in the repo; add a plugin or a board task to track style setup. | Week 6 Monday lecture (Lecture 11); the build script and config file in the repository for Lab: Code Coverage |
| 2 | SpotBugs: SpotBugs is set up or there is a to-do item planned in the Project Management board for this task. (needed for Letter Grade B)     | ⚠️     | No `spotbugs` setup found; create a simple task to add SpotBugs to the Gradle build. | Week 6 Monday lecture (Lecture 11); the build script and config file in the repository for Lab: Code Coverage |

### Planning & Progress Evaluation
| # | Item                                                                                                                                                         |  Status   | Reviewer Notes      | Source Instructions or Resources                                                  |
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|-----------------------------------------------------------------------------------|
| 4 | The team documents every week’s planning and progress evaluation professionally. (needed for Letter Grade B)                                                 | ⚠️        | `docs/weekly-reports/report.md` still has Week 3 placeholders; add Week 4/5 real entries with PR links. | Week 4 Wednesday Lecture (Lecture 08), Project grading rubrics                    |

### Progress & Collaboration
| # | Item                                                                                                                                                                                   |  Status   | Reviewer Notes      | Source Instructions or Resources                 |
|---|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|--------------------------------------------------|
| 5 | Overall development progress (recall the recommended order is: Game Setup Phase -> One turn of the game -> Multiple turns -> One win condition -> Other win conditions (if applicable) | ❌        | Project is still pre-implementation; focus this sprint on one domain class and its tests to make progress. | Canvas assignment Project: Week 4 and 5 Guidance |
...
## Additional Comments
The team should focus on moving from planning into actual implementation soon, since the project is still largely in the setup phase. A good next milestone would be completing one simple domain class with accompanying tests and integrating it into a basic game flow. Also make sure to update the weekly reports with current entries and PR links so progress is easier to track. Finally, don’t forget to merge the older feedback PR and add Checkstyle and SpotBugs tasks to the board to stay aligned with upcoming project requirements.